...
SECRET_KEY = 'django-insecure-*5msfh+2gn#(4^57_2vt#c*_5e6csch38_!)b!o(gp&yw8spz-'
...
import os
# decirle a django donde guardar y buscar los archivos media (imagenes y videos)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
# TAMBIEN SIRVE COLOCAR
